...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //UINavigationControllerにrootViewを追加して初期化
    self.naviController = [[UINavigationController alloc] initWithRootViewController:rootView];
    
    //UINavigationControllerのを画面に登録
